        ...
        <div class="col-sm-12 col-xl-12">
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="theme-form" method="POST" action="<?=url('admin/banners/update/'.$banner['id'])?>" enctype="multipart/form-data">
                                <div class="mb-3">
                                    <label for="title" class="col-form-label pt-0">URL</label>
                                    <input type="text" class="form-control" id="title" name="url" value="<?= $banner['url']?>">
                                </div>
                                <div class="mb-3">
