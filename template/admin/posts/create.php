        ...
        <div class="col-sm-12 col-xl-12">
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="theme-form" method="POST" action="<?=url('admin/posts/store')?>" enctype="multipart/form-data">
                                <div class="mb-3">
                                ...
                                <div class="mb-3 row select2-drpdwn">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control" id="persian_date_view">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="mb-3 m-t-15 custom-radio-ml">
                                            <div class="form-check radio radio-success mb-1">
                                                <input class="form-check-input" type="radio" name="status" id="radio55" value="enable">
                                                <label class="form-check-label" for="radio55">Enable</label>
                                            </div>
                                            <div class="form-check radio radio-danger mb-0">
                                                <input class="form-check-input" type="radio" name="status" id="radio66" value="disable" checked>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="mb-3 m-t-15">
                                            <div class="form-check checkbox checkbox-primary mb-0">
                                                <input class="form-check-input" id="checkbox-primary-1" type="checkbox" name="selected" value="1">
                                            ...
                                            <div class="form-check checkbox checkbox-success mb-0">
                                                <input class="form-check-input" id="checkbox-primary" type="checkbox" name="breaking_news" value="1">
